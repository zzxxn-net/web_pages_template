...
function shopPage34() {
  ...
  return {
    ...
    setFocus: function (id) {
      ...
      var prevCard = document.querySelector('.focus-card-34[data-product="' + this.focusId + '"]');
      var nextCard = document.querySelector('.focus-card-34[data-product="' + id + '"]');
    ...
    addToCart: function (id) {
      ...
      if (typeof gsap !== "undefined") {
        var btn = document.querySelector('.focus-card-34[data-product="' + id + '"] .btn-34');
    ...
    setupFocusTransitions: function () {
      ...
      setTimeout(function () {
        var cards = document.querySelectorAll(".focus-card-34");
        cards.forEach(function (el) {
          gsap.set(el, { opacity: 0, scale: 0.96 });
        });
        var active = document.querySelector(".focus-card-34--active");
