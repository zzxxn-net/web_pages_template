...
if (typeof document !== "undefined") {
  document.addEventListener("alpine:init", function () {
    if (window.Alpine) window.Alpine.data("signupForm87", signupForm87);
  });
  document.addEventListener("DOMContentLoaded", function () {
    if (window.gsap) window.gsap.from(".s87-viewport", { opacity: 0, y: 14, duration: 0.45, ease: "power2.out" });
  });
}
