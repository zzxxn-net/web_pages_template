/**
 * 회원가입 시안 41 - 현대 판타지 + 단계 분할형(Progressive Form)
 * 상태 변화 강조 · Alpine.js: step(1~4), goNext/goPrev, focusStepInput, 검증 · GSAP: 카드·스텝 전환
 */
...
function runStepIn(stepNum: number): void {
  ...
  const panels = document.querySelectorAll<HTMLElement>('.fstep-panel');
