...
function signupForm126() {
  return {
    ...
    focusNext: function (nextId) {
      var el = document.getElementById('s126-' + nextId);
...
if (typeof document !== 'undefined') {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var g = window.gsap;
    var inner = document.querySelector('.s126-inner');
    var header = document.querySelector('.s126-aside');
    var formWrap = document.querySelector('.s126-form-wrap');
    if (g && inner) {
