...
if (typeof document !== 'undefined') {
  document.addEventListener('alpine:init', function () { if (window.Alpine) window.Alpine.data('signupForm78', signupForm78); });
  document.addEventListener('DOMContentLoaded', function () {
    var g = window.gsap;
    if (g) { var v = document.querySelector('.s78-viewport'); if (v) g.fromTo(v, { opacity: 0, y: 8 }, { opacity: 1, y: 0, duration: 0.45, ease: 'power2.out' }); }
  });
}
