...
function signupForm119() {
  return {
    ...
    focusNext: function (nextId) {
      var el = document.getElementById('s122-' + nextId);
...
if (typeof document !== 'undefined') {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var g = window.gsap;
    var inner = document.querySelector('.s122-inner');
    var header = document.querySelector('.s122-header');
    var formWrap = document.querySelector('.s122-form-wrap');
    if (g && inner) {
