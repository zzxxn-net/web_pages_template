...
if (typeof document !== 'undefined') {
  document.addEventListener('alpine:init', function () {
    if (window.Alpine) window.Alpine.data('signupForm112', signupForm112);
  });
  document.addEventListener('DOMContentLoaded', function () {
    const g = window.gsap;
    const inner = document.querySelector('.s112-inner');
    var header = document.querySelector('.s112-header');
    var formWrap = document.querySelector('.s112-form-wrap');
    if (g && inner) {
