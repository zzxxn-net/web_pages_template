/**
 * 회원가입 시안 44 - 감성 테크 + 단계 분할형(Progressive Form)
 * GSAP 기반 부드러운 전환 · Alpine.js: step(1~4), goNext/goPrev, focusStepInput, 검증 · GSAP: 카드·스텝 전환
 */
...
function runStepIn(stepNum: number): void {
  ...
  const panels = document.querySelectorAll<HTMLElement>('.gtp-panel');
