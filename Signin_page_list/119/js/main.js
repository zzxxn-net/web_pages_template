...
function signupForm119() {
  return {
    ...
    focusNext: function (nextId) {
      var el = document.getElementById('s119-' + nextId);
...
if (typeof document !== 'undefined') {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var g = window.gsap;
    var inner = document.querySelector('.s119-inner');
    var header = document.querySelector('.s119-header');
    var formWrap = document.querySelector('.s119-form-wrap');
    if (g && inner) {
