...
function runPanelIn82(stepNum) {
  var g = window.gsap;
  var panels = document.querySelectorAll('.s82-panel');
...
function signupForm82() {
  return {
    ...
    goNext: function () {
      ...
      this.step = 2;
      requestAnimationFrame(function () { runPanelIn82(2); });
    },
    goPrev: function () {
      this.step = 1;
      requestAnimationFrame(function () { runPanelIn82(1); });
    },
...
if (typeof document !== 'undefined') {
  document.addEventListener('alpine:init', function () { if (window.Alpine) window.Alpine.data('signupForm82', signupForm82); });
