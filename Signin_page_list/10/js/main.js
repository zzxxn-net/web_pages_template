/**
 * 회원가입 시안 10 - Alpine.js 데이터 및 폼 검증 (main.ts 컴파일 결과)
 */
...
if (typeof document !== 'undefined') {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    if (typeof gsap !== 'undefined') {
      gsap.from('.twotone-band', { opacity: 0, y: -12, duration: 0.4, ease: 'power2.out' });
      gsap.from('.twotone-body', { opacity: 0, y: 12, duration: 0.45, delay: 0.1, ease: 'power2.out' });
    }
  });
}
