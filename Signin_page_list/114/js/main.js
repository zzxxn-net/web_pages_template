...
function signupForm114() {
  return {
    ...
    focusNext: function (nextId) {
      var el = document.getElementById('s114-' + nextId);
...
if (typeof document !== 'undefined') {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var g = window.gsap;
    var inner = document.querySelector('.s114-inner');
    var header = document.querySelector('.s114-header');
    var formWrap = document.querySelector('.s114-form-wrap');
    if (g && inner) {
