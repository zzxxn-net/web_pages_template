/**
 * 회원가입 시안 1 - Alpine.js 데이터 및 폼 검증 (main.ts 컴파일 결과)
 */
...
function signupForm() {
  return {
    ...
    handleSubmit() {
      ...
      // MVP: 실제 백엔드 없음. HTMX 연동 시 form 제출은 hx-post로 처리 가능.
      setTimeout(() => {
...
if (typeof document !== 'undefined') {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    if (typeof gsap !== 'undefined') {
      gsap.from('.signup-card', { opacity: 0, y: 16, duration: 0.5, ease: 'power2.out' });
    }
  });
}
