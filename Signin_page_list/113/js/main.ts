...
function signupForm113(): Record<string, unknown> {
  return {
    email: '',
    name: '',
    password: '',
...
if (typeof document !== 'undefined') {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const aside = document.querySelector('.s113-aside');
    const formSection = document.querySelector('.s113-form-section');
    if (g && inner) {
