...
function signupForm119() {
  return {
    ...
    focusNext: function (nextId) {
      var el = document.getElementById('s120-' + nextId);
...
if (typeof document !== 'undefined') {
  document.addEventListener('alpine:init', function () {
    if (window.Alpine) window.Alpine.data('signupForm119', signupForm119);
  });
  document.addEventListener('DOMContentLoaded', function () {
    var g = window.gsap;
    var inner = document.querySelector('.s120-inner');
    var header = document.querySelector('.s120-header');
    var formWrap = document.querySelector('.s120-form-wrap');
    if (g && inner) {
