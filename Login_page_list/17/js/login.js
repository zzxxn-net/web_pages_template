...
function initInputReactive() {
  ...
  fields.forEach((wrap) => {
    ...
    input.addEventListener("focus", () => {
      gsap.to(wrap, { boxShadow: "0 0 0 2px rgba(59, 130, 246, 0.4)", duration: 0.25, ease: "power2.out" });
    });
    input.addEventListener("blur", () => {
      gsap.to(wrap, { boxShadow: "0 1px 3px rgba(0,0,0,0.06)", duration: 0.25, ease: "power2.out" });
    });
  });
}
if (typeof Alpine !== "undefined") Alpine.data("futureFullLogin", futureFullLogin);
